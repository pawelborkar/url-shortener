...
class USER(Base):
    ...
    created_at: Mapped[datetime] = mapped_column(DateTime(datetime.UTC), server_default=func.now())
    update_at: Mapped[datetime | None] = mapped_column(DateTime(datetime.UTC), on_update=func.now(), nullable=True)
